...
/// anchor and the tail (e.g. `~/…/acme/v5-infra/services`). The
...
/// Local hostname(s) for SSH-detection purposes. Both bare ("mini")
/// and dotted ("mini.local") forms are returned so an OSC title in
/// either form matches.
///
