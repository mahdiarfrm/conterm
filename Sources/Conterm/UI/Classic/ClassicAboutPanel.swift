...
/// Classic interface style. Custom About panel — replaces macOS's stock orderFrontStandardAboutPanel
...
@MainActor
final class ClassicAboutPanel {
    static let shared = ClassicAboutPanel()
